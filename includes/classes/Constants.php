<?php
    class Constants {
        ...
        public static $passwordNotAlphanumeric = "Your password must only contain letters and numbers.";
        ...
        public static $emailTaken = "The account already exists for this email address.";
